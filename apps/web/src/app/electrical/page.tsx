    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <Link
            href="/electrical/attendance"
            className="md:col-span-2 bg-gradient-to-r from-amber-400 to-amber-500 text-white rounded-2xl shadow-xl p-8 hover:from-amber-500 hover:to-amber-600 transition-all transform hover:scale-105"
          >
            <div className="text-center">
              <div className="text-6xl mb-4">⏰</div>
              <div className="text-3xl font-bold">勤怠打刻（出勤・退勤）</div>
            </div>
          </Link>
